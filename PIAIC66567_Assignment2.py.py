...
def function9():
    ...
    a =np.arange(2,102) # write your code here
...
def function12():
    ...
    a=np.repeat(arr,3)
    b=np.tile(arr,3)
    ans=np.concatenate((a,b)) #write your code here 
...
def function14():
    ...
    ans = ans=np.split(arr,4) #write your code here 
...
def function18():
    ...
    filter_students = students <100
    x = students[filter_students] # Write you code Here
